...
public class DodajMjernuPostajuController {
	...
	public Integer Id2;
	public Integer Id3;
	public Integer idMjesta;
	public Boolean promjena = false;

	public ObservableList<Mjesto> observableListaMjesta;
	public List<SenzorTemperature> listaTemp;
	public List<SenzorTlakaZraka> listaTlak;
	public List<SenzorVlage> listaVlage;
