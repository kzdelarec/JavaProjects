	...
	private void promjeniVrijednost() {
		drzaveTableView.setOnMouseClicked(new EventHandler<MouseEvent>() {
			...
			public void handle(MouseEvent event) {
				 ...
				 loader.setLocation(getClass().getResource("DodajDrzavu.fxml"));
					try {
						loader.load();
						DodajDrzaveController ctl = (DodajDrzaveController) loader.getController();
						ctl.Id = odabranaDrzava.getId();
						ctl.nazivTextField.setText(odabranaDrzava.getNaziv());
						ctl.povrsinaTextField.setText(odabranaDrzava.getPovrsina().toString());
						...
						stage.setTitle("Meteo Base - Promjena drzave");
